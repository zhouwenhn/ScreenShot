...
import cn.ninegame.gamemanagerhd.share.screenshot.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	private void init(Context context) {
		...
		final View v = inflater.inflate(R.layout.screenshot_crop_image_view,
				this, true);
	...
	public void  zoomCropWindow(Rect reBitmapRect) {
		mCropOverlayView.reCropWindowSize(reBitmapRect);
    }
	/**
	 * @param isHidden is Control hidden cropview
	*/
	public void ControlHiddenCropView(boolean isHidden){
		if (isHidden) {
